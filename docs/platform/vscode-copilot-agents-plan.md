...
|-------|---------------|--------------|
| specflow-assess | ✓ Assessment Complete → Specify Requirements | specflow-specify |
| specflow-specify | ✓ Specification Complete → Conduct Research | specflow-research |
| specflow-specify | ✓ Specification Complete → Create Technical Design | specflow-plan |
| specflow-research | ✓ Research Complete → Create Technical Design | specflow-plan |
| specflow-plan | ✓ Planning Complete → Begin Implementation | specflow-implement |
| specflow-implement | ✓ Implementation Complete → Run Validation | specflow-validate |
| specflow-validate | ✓ Validation Complete → Deploy to Production | specflow-operate |
| specflow-operate | (none - terminal state) | - |
...
1. **Discover**: Find all `.md` files in `.claude/commands/{specflow,speckit}/`
...
| task-330 | Convert specflow commands to Copilot format | task-329 |
...
*Generated by /specflow:plan on 2025-12-08*
