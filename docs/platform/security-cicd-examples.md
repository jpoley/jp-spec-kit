        ...
        with:
          script: |
            ...
            **Findings Summary:**
            ...
            ---
            *Generated by [Specflow](https://github.com/jpoley/jp-spec-kit) Security Scanner*
            `;
...
# Check if Specflow is installed
if ! command -v specify &> /dev/null; then
    echo "⚠️  Specflow not found, skipping security scan"
    exit 0
fi
