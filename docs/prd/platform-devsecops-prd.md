# PRD: JP Flowspec Platform & DevSecOps
...
| task-195 | Create JP Flowspec Plugin Package | Developer Experience | Low | FR-DX-002 (deferred) |
...
JP Flowspec users face critical platform challenges:
