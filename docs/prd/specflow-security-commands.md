...
**Definition**: Percentage of JP Specflow projects that have run `/specflow:security scan` at least once
...
This section documents the relationship between JP Specflow's `/specflow:security` and the [Raptor framework](https://github.com/gadievron/raptor).
