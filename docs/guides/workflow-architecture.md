...
The Specflow workflow synchronizes the `/specflow` command interface with the backlog.md task management system. This document defines the architecture, design decisions, and implementation approach.
