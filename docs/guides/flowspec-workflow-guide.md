...
**Reference**: See `.claude/commands/flowspec/assess.md` for complete assessment framework.
...
**Reference**: See `.claude/commands/flowspec/specify.md` for complete agent context.
...
**Reference**: See `.claude/commands/flowspec/research.md` for complete agent contexts.
...
**Reference**: See `.claude/commands/flowspec/plan.md` for complete agent contexts.
...
**Reference**: See `.claude/commands/flowspec/implement.md` for complete agent contexts.
...
**Reference**: See `.claude/commands/flowspec/validate.md` for complete agent contexts.
...
**Reference**: See `.claude/commands/flowspec/operate.md` for complete agent context.
...
### Command References
- **`/flow:assess`**: `.claude/commands/flowspec/assess.md`
- **`/flow:specify`**: `.claude/commands/flowspec/specify.md`
- **`/flow:research`**: `.claude/commands/flowspec/research.md`
- **`/flow:plan`**: `.claude/commands/flowspec/plan.md`
- **`/flow:implement`**: `.claude/commands/flowspec/implement.md`
- **`/flow:validate`**: `.claude/commands/flowspec/validate.md`
- **`/flow:operate`**: `.claude/commands/flowspec/operate.md`
