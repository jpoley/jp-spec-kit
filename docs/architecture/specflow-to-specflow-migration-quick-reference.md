# /specflow → /specflow Migration - Quick Reference Card
...
- [ ] Rename `memory/specflow_workflow.schema.json`
- [ ] Update schema `$id` field
- [ ] Rename `memory/specflow_workflow.yml`
- [ ] Rename root `specflow_workflow.yml`
- [ ] Update command patterns
- [ ] ✅ Validate: `specify workflow validate`

### Phase 2: Templates ✓
- [ ] Rename `templates/commands/specflow/` directory
- [ ] Update `/specflow:` → `/specflow:` in 31 files
- [ ] Update include paths
- [ ] Update workflow references
- [ ] ✅ Validate: Include path resolution

### Phase 3: Symlinks ✓
- [ ] Delete `.claude/commands/specflow/`
...
| Find | Replace | Files |
|------|---------|-------|
| `/specflow:` | `/specflow:` | All |
| `specflow_workflow` | `specflow_workflow` | Config, code, docs |
| `commands/specflow/` | `commands/specflow/` | Templates, agents |
| `specflow-` | `specflow-` | Agents |
| `test_specflow_` | `test_specflow_` | Tests |
| `specflow.` | `specflow.` | Python |
...
git branch -D migration-specflow-to-specflow-$(date +%Y%m%d)
```
...
- **Architect**: Review docs/adr/ADR-specflow-to-specflow-migration-architecture.md
- **Execution Plan**: docs/architecture/specflow-to-specflow-migration-execution-plan.md
- **Summary**: docs/architecture/specflow-to-specflow-migration-summary.md

## Migration Script

**Location**: `scripts/bash/migrate-specflow-to-specflow.sh` (task-417)
