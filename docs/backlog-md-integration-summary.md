...
**Workflow**:
1. **Initial Generation**: `/jpspec:tasks` → Backlog.md tasks created
...
**Acceptance Criteria**:
- ✅ Run `/jpspec:tasks --format backlog-md` on existing feature
...
- **jp-spec-kit**: Current task generation via `/jpspec:tasks`
