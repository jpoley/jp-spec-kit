...
vim .claude/commands/flowspec/implement.md
...
ls -la .claude/commands/flowspec/new-command.md
...
git add .claude/commands/flowspec/new-command.md  # The symlink
...
```bash
# Delete the symlink
git rm .claude/commands/flowspec/old-command.md
```
...
```bash
# Remove old symlink
git rm .claude/commands/flowspec/old-name.md
...
```bash
# Check new symlink
ls -la .claude/commands/flowspec/new-name.md
...
**Step 4: Commit**
```bash
git add .claude/commands/flowspec/new-name.md
...
# Expected output:
# ✓ Created symlink: .claude/commands/flowspec/implement.md
# ✓ Created symlink: .claude/commands/flowspec/research.md
# ...
# ✓ Dev-setup complete
```
...
ls -la .claude/commands/flowspec/implement.md
...
.claude/commands/flowspec/old-command.md
```
