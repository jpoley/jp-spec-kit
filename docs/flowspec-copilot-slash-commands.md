...
For each command in `.claude/commands/flowspec.*.md`, create a corresponding file in `.github/agents/` with:
...
|-------------|-------------|------------|
| `.claude/commands/flowspec.specify.md` | `.github/agents/flowspec.specify.md` | `flowspec.specify` |
| `.claude/commands/flowspec.implement.md` | `.github/agents/flowspec.implement.md` | `flowspec.implement` |
| `.claude/commands/flowspec.assess.md` | `.github/agents/flowspec.assess.md` | `flowspec.assess` |
| `.claude/commands/flowspec.plan.md` | `.github/agents/flowspec.plan.md` | `flowspec.plan` |
| `.claude/commands/flowspec.research.md` | `.github/agents/flowspec.research.md` | `flowspec.research` |
| `.claude/commands/flowspec.validate.md` | `.github/agents/flowspec.validate.md` | `flowspec.validate` |
| `.claude/commands/flowspec.operate.md` | `.github/agents/flowspec.operate.md` | `flowspec.operate` |
| `.claude/commands/flowspec.prune-branch.md` | `.github/agents/flowspec.prune-branch.md` | `flowspec.prune-branch` |
...
cp .claude/commands/flowspec.specify.md .github/agents/flowspec.specify.md
