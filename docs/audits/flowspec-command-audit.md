...
**File**: `.claude/commands/flowspec/research.md`
...
**File**: `.claude/commands/flowspec/operate.md`
...
- `.claude/commands/flowspec/*.md` - Add CLI invocations around Task tool calls
