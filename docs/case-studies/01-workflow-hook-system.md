...
Implementation of a complete hooks system for JP Flowspec, enabling event-driven automation during the SDD workflow. The system includes event models, hook configuration, event emission, and integration with Claude Code hooks.
