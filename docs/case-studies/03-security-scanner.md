...
Integration of security scanning capabilities into JP Spec Kit, including Semgrep orchestration, unified finding format, AI-powered triage, and the `/specflow:security` command. Part of a larger security platform initiative.
