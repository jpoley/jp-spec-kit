...
Implementation of a tiered constitution template system (light/medium/heavy) for JP Flowspec's `specify init` command. Enables projects to choose appropriate governance levels based on their complexity and team size.
