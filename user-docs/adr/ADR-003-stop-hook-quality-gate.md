...
Flowspec uses backlog.md to track tasks through workflows with clear acceptance criteria. When creating PRs, developers should ensure tasks are marked "Done" with all acceptance criteria complete. However, it's easy to forget this quality gate in the flow of creating a PR.
