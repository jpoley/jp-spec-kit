# /jpspec → /specflow Migration - Architecture Summary
...
This document summarizes the comprehensive migration architecture for renaming `/jpspec` to `/specflow` across the JP Spec Kit codebase. The migration affects **912+ occurrences across 150+ files** and requires careful orchestration due to complex dependencies, symlinks, include paths, and cross-file references.

## Deliverables Created

### 1. Architecture Decision Record (ADR)
**Location**: `/home/jpoley/ps/jp-spec-kit/docs/adr/ADR-jpspec-to-specflow-migration-architecture.md`
...
### 2. Execution Plan
**Location**: `/home/jpoley/ps/jp-spec-kit/docs/architecture/jpspec-to-specflow-migration-execution-plan.md`
...
|------|----------|-------|----------|----------|
| 1 | Configuration | 4 | Critical | jpspec_workflow.yml, schema.json |
| 2 | Templates | 31 | Critical | templates/commands/jpspec/*.md |
| 3 | Symlinks | 18 | Critical | .claude/commands/jpspec/*.md |
| 4 | Agents | 15 | High | .github/agents/jpspec-*.agent.md |
| 5 | Tests | 10 | High | tests/test_jpspec_*.py |
...
|---------|-------------|-------------|--------|
| `/jpspec:` | `/specflow:` | 750+ | **CRITICAL** - Command invocations |
| `jpspec_workflow` | `specflow_workflow` | 100+ | **CRITICAL** - Config loading |
| `commands/jpspec/` | `commands/specflow/` | 100+ | **CRITICAL** - Include paths |
| `jpspec-` | `specflow-` | 50+ | High - Agent references |
| `test_jpspec_` | `test_specflow_` | 10 | Medium - Test discovery |
| `jpspec.` | `specflow.` | 10+ | Medium - Event names |
...
**Location**: `scripts/bash/migrate-jpspec-to-specflow.sh` (to be created)
...
2. **Implement Script** (task-417)
   - Create `scripts/bash/migrate-jpspec-to-specflow.sh`
...
⏳ **Deprecation Period**: Provide /jpspec aliases?
...
**Technical**:
- ✅ 0 /jpspec references (except intentional archives)
- ✅ 100% test pass rate
...
### Documentation
- **ADR**: `/home/jpoley/ps/jp-spec-kit/docs/adr/ADR-jpspec-to-specflow-migration-architecture.md`
- **Execution Plan**: `/home/jpoley/ps/jp-spec-kit/docs/architecture/jpspec-to-specflow-migration-execution-plan.md`
- **This Summary**: `/home/jpoley/ps/jp-spec-kit/docs/architecture/jpspec-to-specflow-migration-summary.md`
...
### Related Files
- Existing migration plan: `docs/adr/jpspec-to-specflow-migration-plan.md` (superseded)
- Migration script: `scripts/bash/migrate-jpspec-to-specflow.sh` (to be created)
- Migration guide: `docs/guides/jpspec-to-specflow-migration.md` (to be created)
