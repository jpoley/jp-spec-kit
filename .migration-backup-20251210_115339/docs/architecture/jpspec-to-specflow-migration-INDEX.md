# /jpspec → /specflow Migration - Documentation Index
...
This directory contains comprehensive architecture documentation for migrating all `/jpspec` commands to `/specflow` across the JP Spec Kit codebase. The migration affects **912+ occurrences across 150+ files** and requires **9 sequential phases** with validation checkpoints.

## Documentation Suite

### 1. Architecture Decision Record (ADR)
**File**: `/home/jpoley/ps/jp-spec-kit/docs/adr/ADR-jpspec-to-specflow-migration-architecture.md`
...
### 2. Execution Plan
**File**: `/home/jpoley/ps/jp-spec-kit/docs/architecture/jpspec-to-specflow-migration-execution-plan.md`
...
### 3. Summary Document
**File**: `/home/jpoley/ps/jp-spec-kit/docs/architecture/jpspec-to-specflow-migration-summary.md`
...
**File**: `/home/jpoley/ps/jp-spec-kit/docs/architecture/jpspec-to-specflow-migration-quick-reference.md`
...
**Files**: 31 (entire templates/commands/jpspec/ directory)
**Critical Path**: Yes
...
⏳ **Deprecation**: Provide /jpspec aliases or clean break?
