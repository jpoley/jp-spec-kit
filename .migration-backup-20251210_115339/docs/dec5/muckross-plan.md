...
Muckross is responsible for the **security scanning platform** - the `/jpspec:security` command suite including scanning, AI triage, fix generation, and reporting.
...
| task-215 | Implement /jpspec:security CLI Commands | Done |
| task-247 | Plan /jpspec:security Architecture and Platform | Done |
...
| task-216 | Integrate /jpspec:security with Workflow | task-215 | 2-3 days |
...
9. **task-216** - Integrate with Workflow and Backlog
   - Hook into /jpspec:validate phase
