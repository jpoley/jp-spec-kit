"""Tests for /specflow:validate backlog.md integration.
...
- AC#7: Test: Run /specflow:validate and verify task validation workflow
"""
...
def validate_md_path():
    ...
    return (
        Path(__file__).parent.parent / ".claude" / "commands" / "specflow" / "validate.md"
    )
