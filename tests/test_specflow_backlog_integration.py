"""Integration tests for specflow commands with backlog.md CLI.

This test module verifies that specflow commands correctly interact with the
...
class TestTaskAssignment:
    ...
    def test_assign_task_to_agent(self, mock_backlog_cli, backlog_verifier):
        ...
        # Simulate specflow workflow: assign task and set to In Progress
        subprocess.run(
            [
                "backlog",
                "task",
...
class TestWorkflowCompletion:
    """Tests for complete specflow workflow scenarios."""
