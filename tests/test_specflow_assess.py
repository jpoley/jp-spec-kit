"""Tests for /specflow:assess problem-sizing assessment command.
...
def assess_command_path():
    ...
    return (
        Path(__file__).parent.parent / ".claude" / "commands" / "specflow" / "assess.md"
    )
...
class TestWorkflowIntegration:
    ...
    def test_has_workflow_commands(self, assess_command_content):
        ...
        assert "/specflow:specify" in assess_command_content
