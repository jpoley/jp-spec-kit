...
$TEMPLATE_FILE = Join-Path $REPO_ROOT '.flowspec/templates/agent-file-template.md'
...
function Validate-Environment {
    ...
    if (-not (Test-Path $TEMPLATE_FILE)) {
        ...
        Write-Info 'Run flowspec init to scaffold .flowspec/templates, or add agent-file-template.md there.'
        exit 1
    }
}
