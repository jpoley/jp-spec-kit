---
id: task-114
title: 'Update /specflow:operate to use backlog.md CLI'
status: Done
assignee:
  - '@claude-opus'
...
- [x] #6 Test: Run /specflow:operate and verify operational tasks created
<!-- AC:END -->

## Implementation Notes

<!-- SECTION:NOTES:BEGIN -->
Updated /specflow:operate command with full backlog.md CLI integration.
...
- Added tests in tests/test_specflow_operate_backlog.py (18 tests, all passing)
<!-- SECTION:NOTES:END -->
