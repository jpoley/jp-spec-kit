---
id: task-135
title: 'Implement /specflow:prune-branch slash command'
status: Done
assignee:
  - '@claude'
...
<!-- SECTION:PLAN:BEGIN -->
1. Create slash command file at .claude/commands/specflow/prune-branch.md
...
<!-- SECTION:NOTES:BEGIN -->
Implemented /specflow:prune-branch slash command that:
...
Tested git commands against current repo - found stale branch specflow-backlog-integration-tasks-v2 that would be correctly identified for pruning.
<!-- SECTION:NOTES:END -->
