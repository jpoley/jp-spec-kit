---
id: task-088
title: Create JSON Schema for specflow_workflow.yml validation
status: Done
assignee: []
...
Create JSON Schema for validating specflow_workflow.yml configuration files to ensure structure, types, and references are correct
<!-- SECTION:DESCRIPTION:END -->

## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 JSON schema file created at memory/specflow_workflow.schema.json
...
- [x] #5 Schema validates workflow commands match /specflow pattern
...
Deliverables:
- memory/specflow_workflow.schema.json (comprehensive schema)
