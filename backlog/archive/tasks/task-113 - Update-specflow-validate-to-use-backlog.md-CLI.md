---
id: task-113
title: 'Update /specflow:validate to use backlog.md CLI'
status: Done
assignee:
  - '@claude-agent'
...
- [x] #7 Test: Run /specflow:validate and verify task validation workflow
<!-- AC:END -->

## Implementation Notes

<!-- SECTION:NOTES:BEGIN -->
Verified /specflow:validate backlog.md CLI integration.
