---
id: task-111
title: 'Update /specflow:research to use backlog.md CLI'
status: Done
assignee:
  - '@claude-agent'
...
- [x] #6 Test: Run /specflow:research and verify research tasks created with findings
<!-- AC:END -->

## Implementation Notes

<!-- SECTION:NOTES:BEGIN -->
Implemented /specflow:research backlog.md integration.

## Changes

### research.md Updates
- Added {{INCLUDE:.claude/commands/specflow/_backlog-instructions.md}} directive to both Phase 1 (Researcher) and Phase 2 (Business Validator) agent prompts
...
## Verification
- All 37 tests in test_specflow_research_backlog.py pass
