---
id: task-109
title: 'Update /specflow:specify to use backlog.md CLI'
status: Done
assignee:
  - '@claude-opus'
...
- [x] #6 Test: Run /specflow:specify and verify tasks appear in backlog with correct format
<!-- AC:END -->

## Implementation Notes

<!-- SECTION:NOTES:BEGIN -->
Updated /specflow:specify command with full backlog.md CLI integration.
...
- Added tests in tests/test_specflow_specify_backlog.py (18 tests, all passing)
<!-- SECTION:NOTES:END -->
