---
id: task-286
title: Constitution Enforcement in /specflow Commands
status: Done
assignee: []
...
Add constitution checks to all /specflow slash commands before execution
...
<!-- SECTION:NOTES:BEGIN -->
Already implemented - `_constitution-check.md` included in all specflow commands. Branch merged to main.
<!-- SECTION:NOTES:END -->
