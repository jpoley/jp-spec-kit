...
if [ -f "memory/constitution.md" ]; then
  ...
  echo "  2. Then: Run /flow:constitution to customize"
  echo ""
...
Consider running /flow:constitution to customize your constitution.
...
Options:
  ...
  2. Run /flow:constitution to customize
...
- If user responds `n`, `no`, or empty/Enter -> Stop and show:
  ```text
  Command cancelled. Run /flow:constitution to customize your constitution.
  ```
...
To resolve:
  1. Run /flow:constitution to customize your constitution
...
| `/flow:constitution` | Interactive constitution customization |
