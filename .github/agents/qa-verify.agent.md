...
Each validator agent context below includes `{{BACKLOG_INSTRUCTIONS}}` which must be replaced with the content from `.claude/commands/flowspec/_backlog-instructions.md`. This ensures all agents have consistent backlog task management instructions.
...
6. [x] Updates .claude/commands/flowspec/validate.md
