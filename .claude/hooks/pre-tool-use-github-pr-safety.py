...
def check_merge_safety(
    ...
    if config["block_pr_merge_to_main"]:
        # For merge_pull_request, we'd need to check the PR's base branch
        # Since we don't have that info directly, we block by default
        # and suggest using the GitHub UI instead
        return (
            "ask",
