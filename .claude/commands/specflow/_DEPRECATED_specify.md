---
description: "[DEPRECATED] Use /pm:define instead - Create or update feature specifications using PM planner agent (manages /speckit.tasks)."
deprecated: true
replacement: "/pm:define"
...
Simply replace `/specflow:specify` with `/pm:define` in your workflows. The functionality is identical.

**Before**:
```bash
/specflow:specify my-feature
```

**After**:
```bash
/pm:define my-feature
```
...
**Redirecting to /pm:define...**

{{INCLUDE:.claude/commands/pm/define.md}}
