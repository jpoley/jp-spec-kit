---
description: "[DEPRECATED] Use /arch:design instead - Execute planning workflow using project architect and platform engineer agents (builds out /speckit.constitution)."
deprecated: true
replacement: "/arch:design"
...
Simply replace `/specflow:plan` with `/arch:design` in your workflows. The functionality is identical.

**Before**:
```bash
/specflow:plan my-feature
```
...
**Redirecting to /arch:design...**

{{INCLUDE:.claude/commands/arch/design.md}}
