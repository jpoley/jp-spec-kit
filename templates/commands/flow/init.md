...
3. If customize, suggest `/flow:constitution` for detailed customization
...
💡 TIP: Run '/flow:constitution' for more detailed customization
```
...
- **To customize more**: Run `/flow:constitution` for detailed customization
